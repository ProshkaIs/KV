...
<b>Количество запросов в минуту ограничено до 60 штук, если этот лимит превышен, то сервис ничего не возвращает в теле ответа и возвращает ошибку 503 в headers.</b>
