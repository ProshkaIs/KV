...
<b>Количество запросов в минуту ограничено до 60 штук, если этот лимит превышен, то сервис ничего не возраащет в теле ответа и возращает ошибку 503 в headers.</b>
